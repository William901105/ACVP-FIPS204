...
def unsupported_formal_registration() -> JSONResponse:
    return acvp_skeleton_error(
        501,
        "FORMAL_CAPABILITIES_NEGOTIATION_NOT_IMPLEMENTED",
        "Formal ACVP capabilities negotiation is planned for Phase 3-3.",
        "$",
    )
            ...
            "algorithms": [
                {
                    ...
                    "localOracleLimitations": [
                        ...
                        "Formal production registration negotiation is not implemented.",
